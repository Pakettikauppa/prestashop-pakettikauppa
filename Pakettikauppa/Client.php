...
class Client
{
    ...
    public function __construct(array $params)
    {
        ...
        if(isset($params['test_mode']) and $params['test_mode'] === true) {
           $this->api_key      =  Configuration::get('PAKETTIKAUPPA_API_KEY');
            $this->secret       = Configuration::get('PAKETTIKAUPPA_SECRET');
            $this->base_uri     = Configuration::get('PAKETTIKAUPPA_BASE_URI');
        } else {
